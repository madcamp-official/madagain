...
## UDP `InputPacket` 와이어 포맷 (리틀 엔디언, 고정 길이)
...
| 21 | (padding) | — | 3 |
| 24 | NormX, NormY | float×2 | 8 |
| 32 | GyroQuat (x,y,z,w) | float×4 | 16 |
| 48 | Accel (x,y,z) | float×3 | 12 |
| — | **총** | | **60** |
...
- 터치 정규화 좌표: 프레임 간 **Lerp**.
- 자이로 쿼터니언: 프레임 간 **Slerp**.
